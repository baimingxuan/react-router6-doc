import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.0e8ae64e.js";const F=JSON.parse('{"title":"useLoaderData","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/use-loader-data.md","filePath":"hooks/use-loader-data.md","lastUpdated":1699184691000}'),o={name:"hooks/use-loader-data.md"},p=l(`<h1 id="useloaderdata" tabindex="-1"><code>useLoaderData</code> <a class="header-anchor" href="#useloaderdata" aria-label="Permalink to &quot;\`useLoaderData\`&quot;">​</a></h1><p>此钩子提供路由<code>loader</code>返回的值。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> {</span></span>
