import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.0e8ae64e.js";const F=JSON.parse('{"title":"createStaticRouter","description":"","frontmatter":{},"headers":[],"relativePath":"router/create-static-router.md","filePath":"router/create-static-router.md","lastUpdated":1699184691000}'),o={name:"router/create-static-router.md"},p=l(`<h1 id="createstaticrouter" tabindex="-1"><code>createStaticRouter</code> <a class="header-anchor" href="#createstaticrouter" aria-label="Permalink to &quot;\`createStaticRouter\`&quot;">​</a></h1><p><code>createStaticRouter</code> 用于在服务器（即 <a href="https://nodejs.org/" target="_blank" rel="noreferrer">Node</a> 或其他 Javascript 运行时）上利用<a href="https://baimingxuan.github.io/react-router6-doc/routers/picking-a-router" target="_blank" rel="noreferrer">数据路由</a>进行渲染。有关更全面的概述，请参阅<a href="https://baimingxuan.github.io/react-router6-doc/guides/ssr" target="_blank" rel="noreferrer">服务器端渲染</a>指南。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="color:#24292E;">)</span><span style="color:#D73A49;">:</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">Router</span><span style="color:#24292E;">;</span></span></code></pre></div><p><strong>另请参见:</strong></p><ul><li><a href="https://baimingxuan.github.io/react-router6-doc/routers/create-static-handler" target="_blank" rel="noreferrer"><code>createStaticHandler</code></a></li><li><a href="https://baimingxuan.github.io/react-router6-doc/routers/static-router-provider" target="_blank" rel="noreferrer"><code>&lt;StaticRouterProvider&gt;</code></a></li></ul>`,7),e=[p];function t(r,c,E,y,i,u){return a(),n("div",null,e)}const h=s(o,[["render",t]]);export{F as __pageData,h as default};
