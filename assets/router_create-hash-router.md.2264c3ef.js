import{_ as s,o as a,c as n,Q as o}from"./chunks/framework.6f0990a9.js";const F=JSON.parse('{"title":"createHashRouter","description":"","frontmatter":{},"headers":[],"relativePath":"router/create-hash-router.md","filePath":"router/create-hash-router.md","lastUpdated":1699451704000}'),l={name:"router/create-hash-router.md"},p=o(`<h1 id="createhashrouter" tabindex="-1"><code>createHashRouter</code> <a class="header-anchor" href="#createhashrouter" aria-label="Permalink to &quot;\`createHashRouter\`&quot;">​</a></h1><p>如果您无法配置 Web 服务器将所有流量定向到 React Router 应用程序，那么这个路由就非常有用。它不使用普通 URL，而是使用 URL 的哈希 (#) 部分来管理 &quot;应用程序 URL&quot;。</p><blockquote><p>不建议使用哈希 URL。</p></blockquote><p>除此之外，它在功能上与<a href="https://baimingxuan.github.io/react-router6-doc/routers/create-browser-router" target="_blank" rel="noreferrer"><code>createBrowserRouter</code></a>相同。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">*</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">as</span><span style="color:#E1E4E8;"> React </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;react&quot;</span><span style="color:#E1E4E8;">;</span></span>
