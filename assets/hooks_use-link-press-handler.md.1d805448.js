import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.6f0990a9.js";const u=JSON.parse('{"title":"useLinkPressHandler","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/use-link-press-handler.md","filePath":"hooks/use-link-press-handler.md","lastUpdated":1704271911000}'),p={name:"hooks/use-link-press-handler.md"},o=l(`<h1 id="uselinkpresshandler" tabindex="-1"><code>useLinkPressHandler</code> <a class="header-anchor" href="#uselinkpresshandler" aria-label="Permalink to &quot;\`useLinkPressHandler\`&quot;">​</a></h1><p>类型声明</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">declare</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">function</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">useLinkPressHandler</span><span style="color:#E1E4E8;">(</span></span>
