...
<span class="line"><span style="color:#24292E;">};</span></span></code></pre></div><p>将 <code>&lt;Route handle&gt;</code> 与 <code>useMatches</code> 配对后，功能会变得非常强大，因为您可以将任何想要的东西放在 <code>handle</code> 路由上，并在任何地方访问 <code>useMatches</code> 。</p><p><code>useMatches</code> 只适用于<a href="./../routers/create-browser-router"><code>createBrowserRouter</code></a>这样的数据路由，因为它们预先知道完整的路由树，可以提供所有当前匹配结果。此外， <code>useMatches</code> 不会向下匹配到任何子路由树，因为路由器不知道子路由。</p><h2 id="面包屑" tabindex="-1">面包屑 <a class="header-anchor" href="#面包屑" aria-label="Permalink to &quot;面包屑&quot;">​</a></h2><p>众所周知，这里的用例是将面包屑添加到使用子路由数据的父布局中。</p><p><code>app.jsx</code></p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#79B8FF;">Route</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">element</span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;">{&lt;</span><span style="color:#79B8FF;">Root</span><span style="color:#E1E4E8;"> /&gt;}&gt;</span></span>
