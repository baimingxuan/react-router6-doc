import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.0e8ae64e.js";const u=JSON.parse('{"title":"useLinkClickHandler","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/use-link-click-handler.md","filePath":"hooks/use-link-click-handler.md","lastUpdated":1699184691000}'),p={name:"hooks/use-link-click-handler.md"},o=l(`<h1 id="uselinkclickhandler" tabindex="-1"><code>useLinkClickHandler</code> <a class="header-anchor" href="#uselinkclickhandler" aria-label="Permalink to &quot;\`useLinkClickHandler\`&quot;">​</a></h1><p>类型声明</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">declare</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">function</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">useLinkClickHandler</span><span style="color:#E1E4E8;">&lt;</span></span>
