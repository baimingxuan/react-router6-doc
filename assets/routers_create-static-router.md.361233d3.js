import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.6f0990a9.js";const F=JSON.parse('{"title":"createStaticRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/create-static-router.md","filePath":"routers/create-static-router.md","lastUpdated":1703598242000}'),o={name:"routers/create-static-router.md"},p=l(`<h1 id="createstaticrouter" tabindex="-1"><code>createStaticRouter</code> <a class="header-anchor" href="#createstaticrouter" aria-label="Permalink to &quot;\`createStaticRouter\`&quot;">​</a></h1><p><code>createStaticRouter</code> 用于在服务器（即 <a href="https://nodejs.org/" target="_blank" rel="noreferrer">Node</a> 或其他 Javascript 运行时）上利用<a href="./../routers/picking-a-router">数据路由</a>进行渲染。有关更全面的概述，请参阅<a href="./../guides/ssr">服务器端渲染</a>指南。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> {</span></span>
