...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">)</span><span style="color:#D73A49;">:</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">RemixRouter</span><span style="color:#24292E;">;</span></span></code></pre></div><h2 id="routes" tabindex="-1"><code>routes</code> <a class="header-anchor" href="#routes" aria-label="Permalink to &quot;\`routes\`&quot;">​</a></h2><p><a href="./../components/route"><code>Route</code></a> 对象的数组，在 <code>children</code> 属性上有嵌套路由。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">createBrowserRouter</span><span style="color:#E1E4E8;">([</span></span>
<span class="line"><span style="color:#E1E4E8;">  {</span></span>
<span class="line"><span style="color:#E1E4E8;">    path: </span><span style="color:#9ECBFF;">&quot;/&quot;</span><span style="color:#E1E4E8;">,</span></span>
<span class="line"><span style="color:#E1E4E8;">    element: &lt;</span><span style="color:#79B8FF;">Root</span><span style="color:#E1E4E8;"> /&gt;,</span></span>
<span class="line"><span style="color:#E1E4E8;">    loader: rootLoader,</span></span>
...
<span class="line"><span style="color:#24292E;">  basename: </span><span style="color:#032F62;">&quot;/app/&quot;</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">});</span></span>
<span class="line"><span style="color:#24292E;">&lt;</span><span style="color:#005CC5;">Link</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">to</span><span style="color:#D73A49;">=</span><span style="color:#032F62;">&quot;/&quot;</span><span style="color:#24292E;"> /&gt;; </span><span style="color:#6A737D;">// results in &lt;a href=&quot;/app/&quot; /&gt;</span></span></code></pre></div><h2 id="future" tabindex="-1"><code>future</code> <a class="header-anchor" href="#future" aria-label="Permalink to &quot;\`future\`&quot;">​</a></h2><p>为路由器启用的一组可选的 <a href="./../guides/api-development-strategy">Future Flags</a>。我们建议您尽早选择使用新发布的 future flags，以方便您最终迁移到 v7 版本。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">router</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">createBrowserRouter</span><span style="color:#E1E4E8;">(routes, {</span></span>
...
<span class="line"><span style="color:#24292E;">  },</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><p>目前可用的<code>future flags</code>如下：</p><table><thead><tr><th>Flag</th><th>Description 说明</th></tr></thead><tbody><tr><td><code>v7_fetcherPersist</code></td><td>延迟活动的<code>fetcher</code>清理，直到它们返回到 <code>idle</code> 状态</td></tr><tr><td><code>v7_normalizeFormMethod</code></td><td>将 <code>useNavigation().formMethod</code> 规范化为大写的 HTTP 方法</td></tr><tr><td><code>v7_partialHydration</code></td><td>支持服务端渲染应用程序的部分水合功能</td></tr><tr><td><code>v7_prependBasename</code></td><td>将路由的基名添加到<code>navigate/fetch</code>路径的前面</td></tr><tr><td><a href="./../hooks/use-resolved-path#splat-paths"><code>v7_relativeSplatPath</code></a></td><td>修复<code>splat</code> 路由中相对路径解析的错误</td></tr></tbody></table><h2 id="hydrationdata" tabindex="-1"><code>hydrationData</code> <a class="header-anchor" href="#hydrationdata" aria-label="Permalink to &quot;\`hydrationData\`&quot;">​</a></h2><p>在进行<a href="./../guides/ssr">服务器渲染</a>并<a href="./../routers/static-router-provider#hydrate">选择退出自动水合</a>时， <code>hydrationData</code> 选项允许您从服务器渲染器中传递水合数据。这几乎总是从 <a href="./../routers/create-static-handler#handlerqueryrequest-opts">handler.query</a> 返回的 <code>StaticHandlerContext</code> 值数据的子集：</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">router</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">createBrowserRouter</span><span style="color:#E1E4E8;">(routes, {</span></span>
<span class="line"><span style="color:#E1E4E8;">  hydrationData: {</span></span>
<span class="line"><span style="color:#E1E4E8;">    loaderData: {</span></span>
<span class="line"><span style="color:#E1E4E8;">      </span><span style="color:#6A737D;">// [routeId]: serverLoaderData</span></span>
<span class="line"><span style="color:#E1E4E8;">    },</span></span>
<span class="line"><span style="color:#E1E4E8;">    </span><span style="color:#6A737D;">// may also include \`errors\` and/or \`actionData\`</span></span>
<span class="line"><span style="color:#E1E4E8;">  },</span></span>
<span class="line"><span style="color:#E1E4E8;">});</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#D73A49;">const</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">router</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">=</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">createBrowserRouter</span><span style="color:#24292E;">(routes, {</span></span>
<span class="line"><span style="color:#24292E;">  hydrationData: {</span></span>
<span class="line"><span style="color:#24292E;">    loaderData: {</span></span>
<span class="line"><span style="color:#24292E;">      </span><span style="color:#6A737D;">// [routeId]: serverLoaderData</span></span>
<span class="line"><span style="color:#24292E;">    },</span></span>
<span class="line"><span style="color:#24292E;">    </span><span style="color:#6A737D;">// may also include \`errors\` and/or \`actionData\`</span></span>
<span class="line"><span style="color:#24292E;">  },</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h3 id="partial-hydration-data" tabindex="-1">Partial Hydration Data <a class="header-anchor" href="#partial-hydration-data" aria-label="Permalink to &quot;Partial Hydration Data&quot;">​</a></h3><p>在服务器渲染的应用程序中，你几乎总是会包含一套完整的 <code>loaderData</code> 。但在高级用例（如 Remix 的 <a href="https://remix.run/route/client-loader" target="_blank" rel="noreferrer"><code>clientLoader</code></a> ）中，你可能只想在服务器上渲染的某些路由中包含 <code>loaderData</code> 。如果您想启用部分 <code>loaderData</code> 并选择使用细粒度的 <a href="./../route/hydrate-fallback-element"><code>route.HydrateFallback</code></a> ，则需要启用 <code>future.v7_partialHydration</code> 标志。在启用此标记之前，任何提供的 <code>loaderData</code> 都被认为是完整的，不会导致路由加载器在初始水合时执行。</p><p>指定此标记后，加载器将在两种情况下运行初始水合：</p><ul><li>未提供水合数据 <ul><li>在这种情况下， <code>HydrateFallback</code> 成分将在初始水合时呈现</li></ul></li><li><code>loader.hydrate</code> 属性设置为 \`true <ul><li>这样，即使在初始水合时没有渲染<code>fallback</code>（即使用水合数据对缓存进行初始化），也可以运行 <code>loader</code></li></ul></li></ul><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">router</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">createBrowserRouter</span><span style="color:#E1E4E8;">(</span></span>
<span class="line"><span style="color:#E1E4E8;">  [</span></span>
<span class="line"><span style="color:#E1E4E8;">    {</span></span>
...
<span class="line"><span style="color:#E1E4E8;">      children: [</span></span>
<span class="line"><span style="color:#E1E4E8;">        {</span></span>
<span class="line"><span style="color:#E1E4E8;">          id: </span><span style="color:#9ECBFF;">&quot;index&quot;</span><span style="color:#E1E4E8;">,</span></span>
<span class="line"><span style="color:#E1E4E8;">          loader: indexLoader,</span></span>
<span class="line"><span style="color:#E1E4E8;">          HydrateFallback: IndexSkeleton,</span></span>
...
<span class="line"><span style="color:#E1E4E8;">    hydrationData: {</span></span>
<span class="line"><span style="color:#E1E4E8;">      loaderData: {</span></span>
<span class="line"><span style="color:#E1E4E8;">        root: </span><span style="color:#9ECBFF;">&quot;ROOT DATA&quot;</span><span style="color:#E1E4E8;">,</span></span>
<span class="line"><span style="color:#E1E4E8;">        </span><span style="color:#6A737D;">// No index data provided</span></span>
<span class="line"><span style="color:#E1E4E8;">      },</span></span>
<span class="line"><span style="color:#E1E4E8;">    },</span></span>
<span class="line"><span style="color:#E1E4E8;">  }</span></span>
<span class="line"><span style="color:#E1E4E8;">);</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#D73A49;">const</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">router</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">=</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">createBrowserRouter</span><span style="color:#24292E;">(</span></span>
...
<span class="line"><span style="color:#24292E;">      children: [</span></span>
<span class="line"><span style="color:#24292E;">        {</span></span>
<span class="line"><span style="color:#24292E;">          id: </span><span style="color:#032F62;">&quot;index&quot;</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">          loader: indexLoader,</span></span>
<span class="line"><span style="color:#24292E;">          HydrateFallback: IndexSkeleton,</span></span>
...
<span class="line"><span style="color:#24292E;">    hydrationData: {</span></span>
<span class="line"><span style="color:#24292E;">      loaderData: {</span></span>
<span class="line"><span style="color:#24292E;">        root: </span><span style="color:#032F62;">&quot;ROOT DATA&quot;</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">        </span><span style="color:#6A737D;">// No index data provided</span></span>
<span class="line"><span style="color:#24292E;">      },</span></span>
<span class="line"><span style="color:#24292E;">    },</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">);</span></span></code></pre></div><h2 id="window" tabindex="-1"><code>window</code> <a class="header-anchor" href="#window" aria-label="Permalink to &quot;\`window\`&quot;">​</a></h2><p>对于浏览器 devtool 插件或测试等环境来说，使用与全局 <code>window</code> 不同的窗口非常有用。</p>`,30),e=[p];function t(r,c,E,y,i,d){return a(),n("div",null,e)}const F=s(o,[["render",t]]);export{h as __pageData,F as default};
