...
<span class="line"><span style="color:#24292E;">/&gt;</span></span></code></pre></div><h2 id="future" tabindex="-1"><code>future</code> <a class="header-anchor" href="#future" aria-label="Permalink to &quot;\`future\`&quot;">​</a></h2><p>一组可选的 <a href="./../guides/api-development-strategy">Future Flags</a>。我们建议您尽早选择使用新发布的 future flags，以方便您最终迁移到 v7版本。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">function</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">App</span><span style="color:#E1E4E8;">() {</span></span>
