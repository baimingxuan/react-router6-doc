import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.6f0990a9.js";const F=JSON.parse('{"title":"useLoaderData","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/use-loader-data.md","filePath":"hooks/use-loader-data.md","lastUpdated":1699498063000}'),o={name:"hooks/use-loader-data.md"},p=l(`<h1 id="useloaderdata" tabindex="-1"><code>useLoaderData</code> <a class="header-anchor" href="#useloaderdata" aria-label="Permalink to &quot;\`useLoaderData\`&quot;">​</a></h1><p>此钩子提供路由<code>loader</code>返回的值。</p><div class="language-jsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="color:#24292E;">);</span></span></code></pre></div><p>调用路由<a href="https://baimingxuan.github.io/react-router6-doc/components/route#action" target="_blank" rel="noreferrer">操作</a>后，数据将自动重新验证，并返回加载器的最新结果。</p><p>请注意， <code>useLoaderData</code> <em>不会触发获取操作</em>。它只是读取 React Router 在内部管理的获取结果，因此您不必担心它在路由之外的重新渲染时重新获取。</p><p>这也意味着返回的数据在两次渲染之间是稳定的，因此您可以安全地将其传递给 React 钩子中的依赖关系数组，如 <code>useEffect</code> 。只有在操作或某些导航后再次调用<code>loader</code>时，数据才会发生变化。在这种情况下，标识会发生变化（即使值不会发生变化）。</p><p>您可以在任何组件或任何自定义钩子中使用此钩子，而不仅仅是 Route 元素。它会根据上下文从最近的路由返回数据。</p><p>要从页面上的任何活动路由获取数据，请参阅<a href="https://baimingxuan.github.io/react-router6-doc/hooks/use-route-loader-data" target="_blank" rel="noreferrer"><code>useRouteLoaderData</code></a>。</p>`,8),e=[p];function t(r,c,E,y,i,d){return a(),n("div",null,e)}const h=s(o,[["render",t]]);export{F as __pageData,h as default};
